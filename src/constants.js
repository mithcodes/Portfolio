  ...
  export const projects = [
    {
      ...
      title: "Gmail",
      description:
        "Built a Gmail-inspired email client with Inbox, Sent, and Compose functionalities",
      image: githubdetLogo,
      tags: ["HTML", "CSS", "JavaScript", "React JS", "Firebase"],
      github: "https://github.com/mithcodes/Gmail.git",
      webapp: "https://gmail-gi77.vercel.app/",
    },
    {
      id: 1,
      title: "ApnaMart",
      description:
        "Apnamart is ecommerce website devloped fully all functionality of ecommerce of showcasing product to users and admin have full control over product add delte edit ",
      image: csprepLogo,
      tags: ["React JS", "Firebase", "Tailwind css", "Redux toolkit", "HTML", "CSS", "JavaScript"],
      github: "https://github.com/mithcodes/ApnaMart.git",
      webapp: "https://github.com/mithcodes/ApnaMart.git",
    },
    {
      id: 2,
      title: "ExpenseTracker",
      description:
        "A React-based web application that provides to track the expense with category wise and can download expenses .",
      image: movierecLogo,
      tags: ["React JS", "API", "HTML", "CSS", "JavaScript"],
      github: "https://github.com/mithcodes/expensesTracker.git",
      webapp: "https://expenses-tracker-jade-six.vercel.app/",
     },
    // {
    //   id: 3,
